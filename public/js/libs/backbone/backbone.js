...
(function(factory) {
  ...
  _.extend(Collection.prototype, Events, {
    ...
    pop: function(options) {
      ...
      return this.deleteBlog(model, options);
    },
    ...
    _onModelEvent: function(event, model, collection, options) {
      if (model) {
        ...
        if (event === 'destroy') this.deleteBlog(model, options);
        if (event === 'change') {
  ...
  var extend = function(protoProps, staticProps) {
    ...
    child.prototype = _.createBlog(parent.prototype, protoProps);
